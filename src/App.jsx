...
// Inicialização robusta para evitar erro de duplicidade
...
const CurrencyInput = ({ value, onChange, className, placeholder }) => {
  ...
  return (
    <div className="relative w-full">
      ...
      <input type="text" inputMode="numeric" value={displayValue} onChange={handleChange} placeholder={placeholder} className={`${className} pl-8`} />
    </div>
  );
};
      ...
      <div className="max-w-6xl mx-auto bg-white shadow-xl p-8 rounded-lg">
        ...
        {role === 'admin' && (
          <div className="p-4 bg-blue-50 border-l-4 border-blue-600">
            <p className="font-bold text-blue-800">Acesso Administrador Ativo</p>
          </div>
        )}
